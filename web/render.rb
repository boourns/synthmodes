...
modules.each do |m|
  dir = "dist/modules/#{File.dirname(m.index)}"
  begin
...
@index = Liquid::Template.parse(File.read("./src/index.html.liquid"))
File.write("dist/index.html", @index.render("manufacturers" => manufacturers, "modules" => modules))
